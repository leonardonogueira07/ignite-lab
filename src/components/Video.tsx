      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex items-start gap-16">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img
                ...
                src="https://avatars.githubusercontent.com/u/62269954?v=4"
                alt=""
              />

              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Leonardo Nogueira</strong>
          ...
          <div className="flex flex-col gap-4">
            <a href="#" className="p-4 text-sm bg-green-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-green-700 transitions-colors">
              <DiscordLogo size={24} />
